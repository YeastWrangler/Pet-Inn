  ...
  return (
    <View style={styles.backGround}>
        <View style={styles.avatarContainer}>
            <Image style={styles.avatar} source={{uri:"https://i.insider.com/60817ec5354dde0018c06960?width=1300&format=jpeg&auto=webp"}}/>
        </View>
        ...
        <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.button} onPress={handlePetsPress}>
                ...
                <Image style={styles.postImage} source={{uri:"https://www.princeton.edu/sites/default/files/styles/full_2x/public/images/2022/02/KOA_Nassau_2697x1517.jpg?itok=Hy5eTACi"}}/>
            </TouchableOpacity>
        </View>
        <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.button} onPress={handleServicesPress}>
                <Text style={styles.buttonText}>Pet Services Posts</Text>
                <Image style={styles.postImage} source={{uri:"https://www.petbusinessinsurance.co.uk/img/dogwalking.jpg"}}/>
            </TouchableOpacity>
        </View>
        ...
        <View style={styles.secondButtonContainer}>
            <TouchableOpacity style={styles.secondButton} onPress={handlePostServices}>
